...
//        val beforeSecond = getSchedule().copy(type = InternalTimetableType.BACHELOR_SESSION_SCHEDULE)
//        val beforeThird = getSchedule().copy(type = InternalTimetableType.BACHELOR_QUARTER_SCHEDULE)
//        val before = listOf(
//            beforeFirst,
//            beforeSecond,
//            beforeThird
